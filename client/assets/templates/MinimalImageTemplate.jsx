...
const MinimalImageTemplate = ({ data, accentColor }) => {
    ...
    return (
        <div className="max-w-5xl mx-auto print:max-w-none bg-white text-zinc-800">
            <div className="grid grid-cols-3">
                ...
                <div className="col-span-1  py-10">
                    ...
                    {data.personal_info?.image && typeof data.personal_info.image === 'string' ? (
                        <div className="mb-6">
                            <img crossOrigin="anonymous" src={data.personal_info.image} alt="Profile" className="w-32 h-32 object-cover rounded-full mx-auto" style={{ background: accentColor+'70' }} />
                        </div>
                    ) : (
                        data.personal_info?.image && typeof data.personal_info.image === 'object' ? (
                            <div className="mb-6">
                                <img crossOrigin="anonymous" src={URL.createObjectURL(data.personal_info.image)} alt="Profile" className="w-32 h-32 object-cover rounded-full mx-auto" />
                            </div>
                        ) : null
                    )}
                </div>
