    ...
    const templates=[
        {
            id:"classic",
            name:"Classic",
            preview:"A clean, traditional resume format with clear sectios and professional typography"
        },
        {
            id:"modern",
            name:"Modern",
            preview:"Sllek design with strategic use of color and modern font choices"
        },
        {
            id:"minimal-image",
            name:"Minimal-Image",
        ...
        },   
        {
            id:"minimal",
            name:"Minimal",
            preview:"Ultra-clean design that puts your contnet front and center"
        }   
    ]
