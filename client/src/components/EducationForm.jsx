            ...
            <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3">
              <div className="flex justify-between items-start">
                ...
                <div className="grid md:grid-cols-2 gap-3">
                 ...
                 <input value={education.graduation_date||""} onChange={(e)=>updateEducation(index,"graduation_date",e.target.value)} type="month" className="px-3 py-2 text-sm" placeholder="start of degree"/>
                 <input value={education.gpa||""} onChange={(e)=>updateEducation(index,"gpa",e.target.value)} type="number" className="px-3 py-2 text-sm" placeholder="write down gpa"/>               
                </div>
