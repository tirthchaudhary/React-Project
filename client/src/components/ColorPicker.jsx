   ...
   const [isOpen,setIsOpen]=useState(false);
    ...
    return(
        <div className="relative"> 
           ...
           {isOpen&&(
            <div className="grid grid-cols-4 w-60 absolute top-full left-0 right-0 p-3 mt-2 z-10 bg-white rounded-md border border-gray-200 shadow-sm">
              {colors.map((color)=>(
                <div onClick={()=>{onChange(color.value);setIsOpen(!isOpen)}} key={color.value} className="relative cursor-pointer group flex flex-col">
